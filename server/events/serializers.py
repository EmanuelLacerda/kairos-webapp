...
class EventSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        if start_date.timestamp() <= current_date:
            ...
            if events:
                raise serializers.ValidationError({"complete_period": "Já existe um evento para este exato período, a sobrescrita de eventos é inválida! Tente novamente."})
